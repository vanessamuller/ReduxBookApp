...
function mapStateToProps(state){
    // Whatever get returned will show up as props inside of book-list
    return{
        books: state.books
    };
}

//Anything returned from this function will extend
// up as props on the BookList container
function mapDispatchToProps(dispatch){
  //whenever selectedBook is called, the result
